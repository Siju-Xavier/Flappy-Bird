...
Hitting the ground or any column ends the game with a "crashed" message.

Reaching the far right side (x > 750) triggers a win condition.

Dynamic Instructions: On-screen text updates based on game state (start, playing, crash, win).
...
Phaser 3 – powerful 2D game framework for rendering, physics, and input handling.
